...
import androidx.compose.ui.unit.dp
import io.silv.core_ui.components.bottomsheet.ModalBottomSheetState.Companion.Saver
import io.silv.core_ui.components.bottomsheet.ModalBottomSheetValue.Expanded
import io.silv.core_ui.components.bottomsheet.ModalBottomSheetValue.HalfExpanded
import io.silv.core_ui.components.bottomsheet.ModalBottomSheetValue.Hidden
...
class ModalBottomSheetState(
    ...
    val anchoredDraggableState =
        io.silv.core_ui.components.bottomsheet.AnchoredDraggableState(
...
internal fun<T> Modifier.draggableAnchors(
    state: io.silv.core_ui.components.bottomsheet.AnchoredDraggableState<T>,
    orientation: Orientation,
...
private class DraggableAnchorsElement<T>(
    private val state: io.silv.core_ui.components.bottomsheet.AnchoredDraggableState<T>,
...
private class DraggableAnchorsNode<T>(
    var state: io.silv.core_ui.components.bottomsheet.AnchoredDraggableState<T>,
...
fun Modifier.modalBottomSheetAnchors(sheetState: ModalBottomSheetState) = this.draggableAnchors(
    state = sheetState.anchoredDraggableState,
...
object ModalBottomSheetDefaults {
    ...
    val scrimColor: Color
        @Composable
        get() = MaterialTheme.colorScheme.background.copy(alpha = 0.32f)
...
private fun ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection(
    state: io.silv.core_ui.components.bottomsheet.AnchoredDraggableState<*>,
    orientation: Orientation

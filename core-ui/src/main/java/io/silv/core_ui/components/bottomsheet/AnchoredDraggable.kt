...
): io.silv.core_ui.components.bottomsheet.DraggableAnchors<T> = MapDraggableAnchors(
...
class AnchoredDraggableState<T>(
    ...
    constructor(
        initialValue: T,
        anchors: io.silv.core_ui.components.bottomsheet.DraggableAnchors<T>,
    ...
    var anchors: io.silv.core_ui.components.bottomsheet.DraggableAnchors<T> by mutableStateOf(
     ...
     */
    fun updateAnchors(
        newAnchors: io.silv.core_ui.components.bottomsheet.DraggableAnchors<T>,
    ...
    suspend fun anchoredDrag(
        ...
        block: suspend AnchoredDragScope.(anchors: io.silv.core_ui.components.bottomsheet.DraggableAnchors<T>) -> Unit
    ) {
        try {
    ...
    suspend fun anchoredDrag(
        targetValue: T,
        dragPriority: MutatePriority = MutatePriority.Default,
        block: suspend AnchoredDragScope.(anchors: io.silv.core_ui.components.bottomsheet.DraggableAnchors<T>, targetValue: T) -> Unit
    ) {
...
private class MapDraggableAnchors<T>(private val anchors: Map<T, Float>) :
    io.silv.core_ui.components.bottomsheet.DraggableAnchors<T> {
